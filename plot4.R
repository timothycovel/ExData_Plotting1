plot4 <- function(){
  ...
  # set the output to a 2x2 figure so we can fit all four plots
  par(mfrow = c(2,2))
  
  
  # using "with" is really convenient when making multiple plots with the same dataset
  with(powerdataset,{
